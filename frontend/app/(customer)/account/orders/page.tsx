      ...
      <div className="mx-auto max-w-5xl space-y-8">
        ...
        {filteredOrders.length === 0 ? (
          ...
          <div className="space-y-6">
            ...
            {totalPages > 1 && (
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-border pt-8 mt-4">
                <span className="text-xs text-muted-foreground font-medium">
                  Showing page <strong className="text-foreground">{page}</strong> of <strong className="text-foreground">{totalPages}</strong> ({totalOrders} total orders)
                </span>
