 ...
 * 
 * 100% Table-Based HTML • Outlook & Apple Mail Certified • Dark-Mode Safe
...
export function getOtpEmailTemplate(otp: string): { html: string; text: string; subject: string } {
  ...
  const text = `AMIN Security Verification Code: ${otp}\n\nUse this 6-digit code to sign in or verify your account.\nThis code expires in 5 minutes.\n\nNever share your OTP with anyone. AMIN Concierge will never ask for this code.`;
    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 8px 0 24px 0;">
      <tr>
        <td align="center" style="background: linear-gradient(135deg, rgba(245, 158, 11, 0.15) 0%, rgba(244, 63, 94, 0.12) 100%); border: 2px dashed #f59e0b; border-radius: 16px; padding: 24px 16px;">
          ...
          <div style="font-size: 44px; font-weight: 900; letter-spacing: 12px; color: #ffffff; font-family: 'Courier New', Courier, monospace; text-shadow: 0 2px 16px rgba(245, 158, 11, 0.5);">${otp}</div>
        </td>
      </tr>
    </table>
      ...
      <tr>
        <td style="padding: 16px 20px;">
          ...
          <div style="color: #94a3b8; font-size: 12px; line-height: 1.6;">
            Please enter this code into your active browser tab. If you did not initiate this request, someone may have mistyped their email. No changes will be made to your account.
          </div>
        </td>
      </tr>
    </table>
